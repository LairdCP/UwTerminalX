...
#define UwVersion                         "1.05n" //Version string
...
#define AutoBaudTimeout                   1700    //Time (in mS) to wait before checking the next baud rate when automatically detected the module's baud rate
