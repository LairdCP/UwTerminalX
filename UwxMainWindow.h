...
#define UwVersion                         "1.05o" //Version string
...
#define AutoBaudTimeout                   2400    //Time (in mS) to wait before checking the next baud rate when automatically detected the module's baud rate
